...
class Chef(models.Model):
    ...
    restaurante = models.ForeignKey(
        Restaurante, on_delete=models.CASCADE, related_name="chefs"
    )
...
class Plato(models.Model):
    ...
    chef = models.ForeignKey(Chef, on_delete=models.CASCADE, related_name="platos")
